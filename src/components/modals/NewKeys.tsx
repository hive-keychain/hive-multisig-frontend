...
function NewKeys({show,setShowNewKeys,privateKey,publicKey}:Iprops) {
    ...
    return (
        <div className="modal newKeysModal"
        ...
        >
            ...
            >
                ...
                <Modal.Body>
                    <div>Please copy and save your keys somewhere safe.</div><br></br>
                    <Stack gap={3}>
